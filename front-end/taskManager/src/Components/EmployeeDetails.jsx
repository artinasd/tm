...
function EmployeeDetails() {
    ...
    useEffect(() => {
        ...
        if (orgCode && accountCode) loadEmployee();
        ...
        return (
            <div className="space-y-4">
                ...
                <div className="rounded-xl bg2 p-8 text-center">
                    ...
                    <p className="text2 mt-2">{error || 'The employee could not be loaded.'}</p>
                </div>
            </div>
        );
    }
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text2 text-sm">Organization employee information</p>
                </div>
            </div>
